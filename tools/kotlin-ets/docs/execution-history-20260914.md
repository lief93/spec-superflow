# Historical Kotlin to ETS execution notes

Archived on 2026-09-14. This file is evidence and decision history, not execution
instructions. The sole active queue is ../task_plan.md. Old worker, automation,
publication and next-action instructions below must not restart historical work.
