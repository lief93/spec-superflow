...
| Secondary constructors | JS lowering creates factories, then factory injection rewrites construction | Keep native primary allocation for secondary this-chains; reuse official IR declaration/body/type/value utilities for source-class static factories. Other allocation families remain pending; see constructors.md. |
...
excluded by inherited-defaults.md, virtual overloads and constructor combinations
excluded by constructors.md. This contract
