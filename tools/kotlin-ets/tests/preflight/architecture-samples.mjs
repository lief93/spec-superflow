...
try {
  ...
  const baseline = {
    ...
    p0Gaps: [
      { category: 'project_dependencies', node: 'compiler_environment',
        responsibleModule: 'tools/kotlin-ets/compiler-environment.mjs',
        detail: 'The public project pins Kotlin 2.1.10; production project generation requires 2.1.20.' },
  ...
  console.log('PASS no target: compiler mismatch, entry contract, and all 10 unsupported calls remain explicit P0 evidence');
} finally {
