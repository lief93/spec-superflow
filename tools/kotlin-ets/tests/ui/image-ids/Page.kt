...
fun selectedScale(crop: Boolean): ContentScale = if (crop) ContentScale.Crop else ContentScale.Fit
@Composable
...
fun Page() {
    Column {
        ...
        Image(chosen(), null, contentScale = selectedScale(true), modifier = Modifier.size(32.dp))
