...
run('ir-compile', 'bash', [compiler, ...['core/Frontend.kt', 'core/OfficialLowerings.kt', 'core/ExpectedNullability.kt', 'core/LibraryInlining.kt', 'core/BinaryBodies.kt', 'core/LocalDeclarations.kt', 'core/ForLoops.kt',
  'core/Contract.kt', 'target/Tree.kt'].map(file => join(root, 'src', file)),
