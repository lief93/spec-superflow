...
assert.ok(process.argv[2], 'Pass successful initialization/run.mjs evidence');
...
const work = mkdtempSync('/private/tmp/kotlin-ets-initialization-sdk-'), host = join(work, 'harmony');
...
console.log(`PASS actual ArkTS SDK: ${modules.length} unchanged initialization modules, ABC and HAP outputs`);
