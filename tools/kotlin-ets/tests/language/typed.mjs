...
run('compile', 'bash', [compiler, ...['target/Tree.kt', 'target/TypeSubstitution.kt', 'target/Validator.kt', 'target/Traversal.kt', 'core/Contract.kt',
  'core/Frontend.kt', 'core/OfficialLowerings.kt', 'core/ExpectedNullability.kt', 'core/LibraryInlining.kt', 'core/BinaryBodies.kt', 'core/LocalDeclarations.kt', 'core/ForLoops.kt', 'language/LanguageLowering.kt', 'language/OverloadNaming.kt'].map(file => join(root, 'src', file)),
