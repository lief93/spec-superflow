...
const paths = [
  ...
  'tests/modules/generic-heritage/Fixture.kt', 'tests/modules/generic-heritage/Contract.kt',
];
...
const result = run('contract', 'java', ['-cp', `${cp}:${join(work, 'test.jar')}`, 'dev.ets.ContractKt', manifest.output]);
