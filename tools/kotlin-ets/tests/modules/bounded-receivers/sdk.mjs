...
assert.ok(process.argv[2], 'Pass successful bounded-receivers/run.mjs evidence after main freeze and SDK slot grant');
...
const work = mkdtempSync('/private/tmp/kotlin-ets-bounded-receivers-sdk-');
...
record();
console.log(`PASS actual ETS SDK: ${modules.length} unchanged bounded receiver modules, checked runtime/interface-only inputs and ABC/HAP output`);
