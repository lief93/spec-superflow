...
const paths = [
  ...
  'tests/modules/generic-heritage/Fixture.kt', 'tests/modules/generic-methods/MethodFixture.kt',
  'tests/modules/generic-methods/MethodContract.kt',
];
...
const result = run('contract', 'java', ['-cp', `${cp}:${join(work, 'test.jar')}`, 'dev.ets.MethodContractKt', manifest.output]);
