...
fun main() {
    ...
    val helpers = listOf("__etsIntDiv", "__etsIntRem", "__etsListGet", "__etsListContains", "__etsListAdd", "__etsListAddAll", "__etsListMap",
    ...
    check(compatibility.count { it.startsWith("function __ets") } == 22) { "UI compatibility" }
