...
assert.deepEqual(expected, ['1/7/10/7/-6/3/fallback/text/5/null/bounded/7/nonnull/23/RBALRCDPREFRHGIRJKRMNOQ',
  '1/7/7/7/-6/0/fallback/text/2/null/bounded/4/nonnull/23/RBALRCDPREFRHGIRJKRMNOQ',
  '1/7/-2147483640/7/-6/-2147483647/fallback/text/-2147483645/null/bounded/-2147483643/nonnull/23/RBALRCDPREFRHGIRJKRMNOQ']);
...
writeFileSync(join(work, 'complete.json'), JSON.stringify({ expected, negatives, application, focusedSnapshotUnchanged: true,
  producerSourceAbsent: true, officialInlineBlocks: 26, hostParity: 'pending shared frozen replay' }, null, 2));
