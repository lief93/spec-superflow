...
run('evidence-build', 'bash', [compiler, ...[
  'core/Frontend.kt', 'core/Constructors.kt', 'core/ConstructorDispatch.kt', 'core/DefaultArguments.kt', 'core/OfficialLowerings.kt', 'core/ExpectedNullability.kt', 'core/LibraryInlining.kt', 'core/BinaryBodies.kt', 'core/LocalDeclarations.kt', 'core/ForLoops.kt',
  'core/Contract.kt', 'core/CallCaptures.kt', 'core/GenericBounds.kt', 'core/SourceSelection.kt', 'core/SourceDiagnostics.kt', 'lower/EtsLoweringPhases.kt', 'lower/EtsBackendContext.kt', 'target/Tree.kt', 'target/Validator.kt', 'target/TypeSubstitution.kt', 'target/Traversal.kt',
