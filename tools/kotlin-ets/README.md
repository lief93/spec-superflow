...
input materializes module-owned drawable/mipmap and values overlays automatically.
Plain strings, `%s`/`%d` formatting, plurals and string arrays become typed
Harmony resources; unsupported styled/ICU/locale cases fail explicitly.
