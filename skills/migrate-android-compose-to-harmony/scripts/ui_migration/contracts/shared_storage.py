"""Lossless, single-file sharing of repeated JSON values."""
import copy
import json

def pack_shared_document(payload, *, storage_key, reference_key, schema):
    STORAGE, REFERENCE, SCHEMA = storage_key, reference_key, schema
    payload = unpack_shared_document(payload, storage_key=STORAGE, reference_key=REFERENCE, schema=SCHEMA)
...
def unpack_shared_document(payload, *, storage_key, reference_key, schema):
    STORAGE, REFERENCE, SCHEMA = storage_key, reference_key, schema
