...
from source_support import MANIFEST_NAME, lexical_code_mask, validate_safe_tree
...
def census(snapshot, scope):
    ...
    payload = {'schema_version': 'behavior-source-census.v1', 'scope': scope,
        ...
        'snapshot_manifest_sha256': hashlib.sha256((Path(snapshot) / MANIFEST_NAME).read_bytes()).hexdigest(),
